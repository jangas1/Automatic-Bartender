...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : cupHoleState1_Pin */
  GPIO_InitStruct.Pin = cupHoleState1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(cupHoleState1_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : diode1_Pin */
  GPIO_InitStruct.Pin = diode1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(diode1_GPIO_Port, &GPIO_InitStruct);
